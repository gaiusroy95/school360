...
const BODY = `360schoolERP collects school-provided student and staff data to deliver attendance, homework, fees, notifications, and related services.

Push notifications use your device token. The transport staff app may collect GPS during active tracking only.
...
const styles = StyleSheet.create({
  ...
  link: { marginTop: 16, fontSize: 13, color: '#2563eb' },
});
