...
const menuItems = [
  ...
  { 
    ...
    subItems: ['General Settings', 'School Settings', 'Academic Settings', 'User & Role Settings', 'Module Settings', 'System Settings', 'Address & Location', 'Maintenance Mode', 'System Limits', 'System Updates', 'Cache Settings', 'Performance Settings', 'Database Optimization', 'Notifications Settings', 'Payment Settings', 'Security Settings', 'Backup & Restore', 'API & Integrations', 'Audit Log', 'Security & Compliance', 'User Governance & Access Control', 'Integrations, APIs & Notifications', 'Document, Identity & Custom Fields', 'Department & Operations Management', 'Data Management, Modules & UI']
  },
  { 
    icon: ShieldAlert, 
